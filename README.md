...
This is a Python utility to create a workspace for [Advent of Code](https://adventofcode.com/) problems. All credits for Advent of Code go to [Eric Wastl](https://was.tl/).
